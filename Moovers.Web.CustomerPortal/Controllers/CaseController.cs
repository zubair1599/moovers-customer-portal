...
namespace MooversCRM.Controllers
{
    public class CaseController : BaseControllers.SecureBaseController
    {
        ...
        public ActionResult Index(string lookup)
        {
            ...
            //var temp =   quote.ToJsonObject(true);
            var InventoryItems = quote.Stops.SelectMany(o => o.Rooms).SelectMany(o => o.Room_InventoryItems).Select(o => o.InventoryItem).Select(o => o.Name).ToList();  //.Select(o => o.Room_InventoryItems).AsEnumerable();
            var SelectedInventoryItems = new SelectList(InventoryItems);

            //var temp = (from q in quote.Stops
            //         from a in q.Rooms



            //.SelectMany(o => o.Room_InventoryItems).SelectMany(o => o.InventoryItem).ToList();
            if (Case == null)
            {
                ...
                claimlistmodel.CaseSubmitStatus = rel.CaseSubmitStatus.HasValue ? Case.CaseSubmitStatus.Value : false;
            }
            else
            {
                ...
                claimlistmodel.CaseSubmitStatus = Case.CaseSubmitStatus.HasValue ? Case.CaseSubmitStatus.Value : false;

            }
            claimlistmodel.InventoryItems = SelectedInventoryItems;
